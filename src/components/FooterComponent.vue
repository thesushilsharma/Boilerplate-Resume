<template>
  <footer
    class="bottom-0 left-0 z-20 w-full p-4  border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6">
    <div class="mx-auto max-w-screen-xl text-center">
      <div class="flex flex-col items-center">
        <h4>Thank you for scrolling all this way!</h4>
      ...
      <div class="flex flex-col items-center">
        <small class="font-bold">
          <span class="inline-flex tracking-wider">
            ...
            </svg>by Sushil Sharma. Reserved All Rights.
          </span>
        </small>
      </div>
    </div>
